    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-gradient-primary flex items-center justify-center [@media(hover:hover)]:group-hover:scale-110 transition-transform">
